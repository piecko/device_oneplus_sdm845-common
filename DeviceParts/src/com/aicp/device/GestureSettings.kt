...
class GestureSettings : PreferenceFragment(), Preference.OnPreferenceChangeListener {
    ...
    private val mInstalledPackages: List<AppSelectListPreference.PackageItem> = LinkedList<AppSelectListPreference.PackageItem>()
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        mOffscreenGestureFeedbackSwitch!!.setChecked(Settings.System.getInt(getContext().getContentResolver(),
                "Settings.System." + com.aicp.device.KeyHandler.Companion.GESTURE_HAPTIC_SETTINGS_VARIABLE_NAME, 1) !== 0)
        ...
        mMusicPlaybackGestureSwitch!!.setChecked(Settings.System.getInt(getContext().getContentResolver(),
                "Settings.System." + com.aicp.device.KeyHandler.Companion.GESTURE_MUSIC_PLAYBACK_SETTINGS_VARIABLE_NAME, 1) !== 0)
        val musicPlaybackEnabled = Settings.System.getIntForUser(getContext().getContentResolver(),
                "Settings.System." + com.aicp.device.KeyHandler.Companion.GESTURE_MUSIC_PLAYBACK_SETTINGS_VARIABLE_NAME, 0, UserHandle.USER_CURRENT) === 1
    ...
    override fun onPreferenceTreeClick(preference: Preference): Boolean {
        if (preference === mOffscreenGestureFeedbackSwitch) {
            Settings.System.putInt(getContext().getContentResolver(),
                    "Settings.System." + com.aicp.device.KeyHandler.Companion.GESTURE_HAPTIC_SETTINGS_VARIABLE_NAME, if (mOffscreenGestureFeedbackSwitch!!.isChecked()) 1 else 0)
            return true
        }
        if (preference === mMusicPlaybackGestureSwitch) {
            Settings.System.putInt(getContext().getContentResolver(),
                    "Settings.System." + com.aicp.device.KeyHandler.Companion.GESTURE_MUSIC_PLAYBACK_SETTINGS_VARIABLE_NAME, if (mMusicPlaybackGestureSwitch!!.isChecked()) 1 else 0)
    ...
    override fun onDisplayPreferenceDialog(preference: Preference) {
        ...
        val fragment: DialogFragment = AppSelectListPreference.AppSelectListPreferenceDialogFragment

...
class SpeakerGainPreference(context: Context?, attrs: AttributeSet?) : Preference(context, attrs), SeekBar.OnSeekBarChangeListener {
    ...
    companion object {
        ...
        private const val FILE_LEVEL = "/sys/kernel/sound_control/speaker_gain"
        const val SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_SPEAKER_GAIN
        const val DEFAULT_VALUE = "3"

...
class SRGBModeSwitch(context: Context) : OnPreferenceChangeListener {
    ...
    companion object {
        private const val FILE = "/sys/devices/platform/soc/ae00000.qcom,mdss_mdp/drm/card0/card0-DSI-1/native_display_srgb_color_mode"
        const val SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_SRGB_SWITCH
        @JvmStatic
        val file: String?
